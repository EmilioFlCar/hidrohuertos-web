...
function Course() {
  return (
    <section id="curso" className="py-20 bg-green-50/30 scroll-mt-[80px]">
      <div className="container mx-auto px-4 md:px-20 max-w-7xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="bg-gray-200 rounded-xl overflow-hidden aspect-video flex items-center justify-center">
            <button className="bg-green-600 text-white rounded-full p-5 hover:bg-green-700 transition-colors">
              <FaPlay className="w-8 h-8 text-white" />
              <span className="sr-only">Reproducir video</span>
            </button>
          </div>
          <div>
            <span className="text-green-600 font-medium mb-2 block">
              CURSO EN HOTMART
            </span>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start">
                <FaCheck className="w-5 h-5 mr-3 text-green-600" />
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center bg-green-600 text-white font-medium px-6 py-3 rounded-lg text-lg hover:bg-green-700 transition-colors"
            >
